...
export class VehicleComponent implements OnInit {
    ...
    displayedColumns: string[] = ['VehicleChesisNo', 'RegistrationNumber', 'TypeOfVehicle', 'Make', 'Model', 'PurchaseDate', 'action'];
    ...
    deleteVehicle(row: any) {
        if (confirm("Are you sure you want to delete vehicle having chesis no " + row.vehicleChesisNo + " ?")) {
